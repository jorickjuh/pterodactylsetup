...
copyright(){
    output "Pterodactyl Installation & Upgrade script v21.0."
    output "Copyright © 2018 Devil <https://blackspigot.com>."
    output "Support BSMC at https://blackspigot.com/account/upgrades"
    output ""
}
